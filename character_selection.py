...
def menu_control(frame,coordinates,root_model,gp_info):
    ...
    print("Orange",gp_info.players["Orange"].character,gp_info.players["Orange"].vehicle)
    print("Blue", gp_info.players["Blue"].character,gp_info.players["Blue"].vehicle)
    print("Red", gp_info.players["Red"].character,gp_info.players["Red"].vehicle)
    print("Green", gp_info.players["Green"].character,gp_info.players["Green"].vehicle)
    print('------')
    return 42
